...
func (h *DashboardHandler) GetSummary(c *gin.Context) {
	...
	resp, err := h.svc.GetSummary(c.Request.Context(), anio, mes)
	if err != nil {
...
func (h *DashboardHandler) GetWeekly(c *gin.Context) {
	...
	resp, err := h.svc.GetWeekly(c.Request.Context(), fecha)
	if err != nil {
		c.JSON(http.StatusInternalServerError, dto.ErrorResponse{Error: err.Error()})
		return
	}
...
func (h *DashboardHandler) GetMonthly(c *gin.Context) {
	...
	resp, err := h.svc.GetMonthly(c.Request.Context(), anio, mes)
	if err != nil {
		c.JSON(http.StatusInternalServerError, dto.ErrorResponse{Error: err.Error()})
		return
	}
...
func (h *DashboardHandler) GetYearly(c *gin.Context) {
	...
	resp, err := h.svc.GetYearly(c.Request.Context(), anio)
	if err != nil {
		c.JSON(http.StatusInternalServerError, dto.ErrorResponse{Error: err.Error()})
		return
	}
...
func (h *DashboardHandler) GetHistory(c *gin.Context) {
	resp, err := h.svc.GetHistory(c.Request.Context())
	if err != nil {
		c.JSON(http.StatusInternalServerError, dto.ErrorResponse{Error: err.Error()})
		return
	}
